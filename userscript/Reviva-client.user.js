...
// @match       https://old.stoat.chat/*
// @grant       none
// @run-at      document-start
// ==/UserScript==

(function(){
if(window.__US_BUILDER_REVOLTPLUGINSREPO_JS__){return;}window.__US_BUILDER_REVOLTPLUGINSREPO_JS__=true;
...
if(window.__US_BUILDER_REVOLTPLUGINS_JS__){return;}window.__US_BUILDER_REVOLTPLUGINS_JS__=true;
...
if(window.__US_BUILDER_REVOLTTHEMES_JS__){return;}window.__US_BUILDER_REVOLTTHEMES_JS__=true;
